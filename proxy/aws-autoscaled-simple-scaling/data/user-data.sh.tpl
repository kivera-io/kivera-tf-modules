...
[[ ${proxy_transparent_enabled} == true ]] && Environment=KIVERA_TRANS_MODE=true
...
# Set up iptables if transparent proxy is enabled
if [[ ${proxy_transparent_enabled} == true ]]; then
cat << EOF | tee /etc/iptables.conf
# Generated by iptables-save v1.8.4 on Mon Feb 19 02:59:10 2024
*mangle
:PREROUTING ACCEPT [23980:6686275]
:INPUT ACCEPT [23962:6684907]
:FORWARD ACCEPT [18:1368]
:OUTPUT ACCEPT [23804:3784087]
:POSTROUTING ACCEPT [23822:3785455]
COMMIT
# Completed on Mon Feb 19 02:59:10 2024
# Generated by iptables-save v1.8.4 on Mon Feb 19 02:59:10 2024
*nat
:PREROUTING ACCEPT [421:26656]
:INPUT ACCEPT [420:26452]
:OUTPUT ACCEPT [3522:229709]
:POSTROUTING ACCEPT [0:0]
-A PREROUTING ! -d 10.4.2.120/32 -p tcp -m tcp --dport 443 -j DNAT --to-destination 10.4.2.120:10080
-A PREROUTING ! -d 10.4.2.120/32 -p tcp -m tcp --dport 443 -j REDIRECT --to-ports 10080
-A POSTROUTING -o eth0 -j MASQUERADE
COMMIT
# Completed on Mon Feb 19 02:59:10 2024
# Generated by iptables-save v1.8.4 on Mon Feb 19 02:59:10 2024
*filter
:INPUT ACCEPT [23957:6683950]
:FORWARD ACCEPT [18:1368]
:OUTPUT ACCEPT [23799:3783699]
-A FORWARD -i gwi-umv9f0jiSvG -o gwi-umv9f0jiSvG -j ACCEPT
COMMIT
# Completed on Mon Feb 19 02:59:10 2024
EOF
