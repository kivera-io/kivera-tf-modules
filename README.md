...
|   ├── performance-test-kivera-config                 # Example Kivera configuration managed using Konfig tool
|   ├── proxy-explicit                                 # Example deployment of an explicit proxy
│   └── proxy-transparent                              # Example deployment of a transparent proxy
|
